		...
		private static ExpansionInfo[] m_Table = new ExpansionInfo[]
			{
				...
				new ExpansionInfo( 6, "Samurai Empire",		ClientFlags.IslesDread,		FeatureFlags.ExpansionSE,	CharacterListFlags.ExpansionSE,		0x00C0 ), // 0x20 | 0x80
				...
				new ExpansionInfo( 8, "Stygian Abyss",		ClientFlags.SavagedEmpire,		FeatureFlags.ExpansionSA,	CharacterListFlags.ExpansionSA,		0x102C0 ) // 0x20 | 0x80 | 0x200 | 0x10000
			};
