	...
	public class SHTeleporter : BaseAddon
	{
		...
		public class SHTeleporterCreator
		{
			...
			public int CreateSHTeleporters()
			{
				...
				tele1.LeftTele.TeleOffset = new Point3D( -1, 3, 0 );
				tele2 = AddSHT( Map.Lodor, false, 5658, 1898, 0 );
				Link( tele1, tele2 );
				...
				tele1.LeftTele.TeleOffset = new Point3D( -1, 3, 0 );
				tele2 = AddSHT( Map.Lodor, true, 1690, 2789, 0 );
				Link( tele1, tele2 );
				...
				tele1.LeftTele.TeleOffset = new Point3D( -1, 3, 0 );
				tele2 = AddSHT( Map.Lodor, false, 5913, 1893, 0 );
				Link( tele1, tele2 );
				...
				Link( tele1, tele2 );
				AddSHT( Map.Lodor, false, 5734, 1859, 0 ).ChangeDest( tele2 );
