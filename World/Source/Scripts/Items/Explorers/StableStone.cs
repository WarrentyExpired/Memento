...
{ 
	...
	{ 
		public override string DefaultDescription{ get{ return "Hitching posts can only be used by grandmasters in camping or an apprentice tamer. Once you place it in your home, you can use it to stable your pets instead of doing so at the stable master."; } }
		...
		public void BeginStable( Mobile from )
		{
			...
			{
				from.SendMessage ("Only grandmasters in camping or an apprentice tamer may stable pets at home!");
			}
