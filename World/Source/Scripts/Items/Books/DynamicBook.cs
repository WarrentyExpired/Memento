...
namespace Server.Items
{
	...
	public class CBookTheLostTribeofVaelen : DynamicBook
	{
		[Constructable]
		public CBookTheLostTribeofVaelen( )
		{
			Weight = 1.0;
			Hue = 0;
			ItemID = 0xFEF;
			...
			SetStaticText( this );
			BookTitle = "Lost Tribe of Vaelen";
			Name = BookTitle;
			BookAuthor = RandomThings.GetRandomAuthor();
		}

		public CBookTheLostTribeofVaelen( Serial serial ) : base( serial )
		{
		}
