	...
	public class ShrinkItem : Item, IShrinkItem
	{
		...
		public override void AddNameProperties( ObjectPropertyList list )
		{
			...
			if ( ShrinkConfig.ShowPetDetails )
			{
				...
				list.Add( 1060660, "Combat Skills\tFistFighting {0}, Tactics {1}, Anatomy {2}, Poisoning {3}", m_FistFighting, m_Tactics, m_Anatomy, m_Poisoning );
				list.Add( 1060661, "Magic Skills\tMagery {0}, Eval Intel {1}, Magic Resist {2}, Meditation {3}", m_Magery, m_Psychology, m_MagicResist, m_Meditation );
				if ( !( 0 == m_Parry && 0 == m_Marksmanship ))
					list.Add( 1060661, "Weapon Skills\tMarksmanship {0}, Fencing {1}, Bludgeoning {2}, Parry {3}, Swords {4}", m_Marksmanship, m_Fencing, m_Bludgeoning, m_Parry, m_Swords );
				if ( m_EvoEp > 0 )
		...
		private void PreloadProperties()
		{
			...
			m_FistFighting = m_Pet.Skills[SkillName.FistFighting].Base;
			...
			m_Psychology = m_Pet.Skills[SkillName.Psychology].Base;
			...
			m_Marksmanship = m_Pet.Skills[SkillName.Marksmanship].Base;
			m_Fencing = m_Pet.Skills[SkillName.Fencing].Base;
			m_Swords = m_Pet.Skills[SkillName.Swords].Base;
			m_Bludgeoning = m_Pet.Skills[SkillName.Bludgeoning].Base;
