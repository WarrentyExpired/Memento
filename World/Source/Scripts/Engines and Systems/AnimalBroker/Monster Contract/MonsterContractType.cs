...
namespace Server.Items
{
	public class MonsterContractType
	{
		public static MonsterContractType[] Get = new MonsterContractType[]
		{
			...
			new MonsterContractType (typeof(DeathwatchBeetle), "Skitters", 61),
			...
			new MonsterContractType (typeof(PandaRiding), "Pandas", 51),
			...
			new MonsterContractType (typeof(Ridgeback), "Stegladons", 43),
			...
			new MonsterContractType (typeof(ZebraRiding), "Zebras", 49)
