...
namespace Server.Spells.Jedi
{
	public abstract class JediSpell : Spell
	{
		...
		public override SkillName CastSkill { get { return SkillName.Psychology; } }
		...
		public static string SpellInfo( int spellID, int slice )
		{
			...
			if ( spellID == 280 ){ name = "Force Grip"; icon="11244"; crystal = "6"; skill = "10"; mana = "5"; mantra = "Drumat"; map = "Vaelen"; dungeon = "the City of Britain"; world = "Land of Vaelen"; jedi = "Jacen Sollo"; scroll = "JediDatacron01"; 
			...
			else if ( spellID == 281 ){ name = "Mind's Eye"; icon="11243"; crystal = "16"; skill = "20"; mana = "8"; mantra = "Vincent"; map = "Vaelen"; dungeon = "the Town of Moon"; world = "Land of Vaelen"; jedi = "Kiadi Mundia"; scroll = "JediDatacron02"; 
			...
			else if ( spellID == 282 ){ name = "Mirage"; icon="11201"; crystal = "24"; skill = "30"; mana = "12"; mantra = "Michal"; map = "Vaelen"; dungeon = "the Village of Grey"; world = "Land of Vaelen"; jedi = "Kip Fisto"; scroll = "JediDatacron03"; 
			...
			else if ( spellID == 283 ){ name = "Throw Sabre"; icon="11215"; crystal = "12"; skill = "40"; mana = "16"; mantra = "Tiana"; map = "Vaelen"; dungeon = "the City of Montor"; world = "Land of Vaelen"; jedi = "Marra Jade"; scroll = "JediDatacron04"; 
			...
			else if ( spellID == 284 ){ name = "Celerity"; icon="11249"; crystal = "80"; skill = "50"; mana = "20"; mantra = "Abigayl"; map = "Vaelen"; dungeon = "the Town of Renika"; world = "the Island of Umber Veil"; jedi = "Numi Sunrider"; scroll = "JediDatacron05"; 
			...
			else if ( spellID == 289 ){ name = "Replicate"; icon="11218"; crystal = "250"; skill = "100"; mana = "40"; mantra = "Leantre"; map = "Vaelen"; dungeon = "the City of Kuldara"; world = "the Bottle World of Kuldar"; jedi = "Coran Horn"; scroll = "JediDatacron10"; 
		...
		public static bool JediNotIllegal( Mobile from, bool checkSword )
		{
			...
			if ( from.FindItemOnLayer( Layer.Helm ) != null )
			{
				...
				if ( ( hat.ItemID == 0x5C14 || hat.ItemID == 0x2B71 || hat.ItemID == 0x2FBE || hat.ItemID == 0x3168 || hat.ItemID == 0x3176 || hat.ItemID == 0x3177 || hat.ItemID == 0x4D09 ) && hat.Name != null && (hat.Name).Contains("Jedi") )
					WearingCloth = true;
			}
			...
			{
				Item talisman = from.FindItemOnLayer( Layer.Trinket );
				if ( talisman.Name != null && (talisman.Name).Contains("Jedi") && talisman.ItemID == 0x543E )
					WearingCloth = true;
			}

			if ( from.Skills[SkillName.Psychology].Base < 10 || from.Skills[SkillName.Swords].Base < 10 || from.Skills[SkillName.Tactics].Base < 10 )
			{
				return false;
			}
		...
		public override bool CheckCast()
		{
			...
			{
				Caster.SendMessage( "You must have at least " + RequiredSkill + " Psychology and Swords to use this power." );
				return false;
			}
		...
		public static int GetTithing( Mobile Caster, JediSpell spell )
		{
		...
		public static int ComputePowerValue( Mobile from, int div )
		{
			...
			int v = (int) Math.Sqrt( from.Karma + 20000 + ( from.Skills.Psychology.Fixed * 10 ) );
		...
		public static bool GetJediSkill( Mobile from, int skill )
		{
			...
			else if ( from.Skills[SkillName.Psychology].Value < skill ){ return false; }
		...
		{
			if ( from.Skills[SkillName.Swords].Value > from.Skills[SkillName.Psychology].Value ){ return from.Skills[SkillName.Swords].Value; }

			return from.Skills[SkillName.Psychology].Value;
		}
