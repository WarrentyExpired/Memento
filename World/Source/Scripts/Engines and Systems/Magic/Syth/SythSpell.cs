...
namespace Server.Spells.Syth
{
	public abstract class SythSpell : Spell
	{
		...
		public static string SpellInfo( int spellID, int slice )
		{
			...
			if ( spellID == 270 ){ name = "Psychokinesis"; icon="1038"; crystal = "6"; skill = "10"; mana = "5"; mantra = "Dzwol Hyal"; map = "Vaelen"; dungeon = "the Fires of Hell"; world = "Land of Vaelen"; syth = "Prince Myrhal of Rax"; scroll = "SythDatacron01"; 
			...
			else if ( spellID == 271 ){ name = "Death Grip"; icon="1002"; crystal = "16"; skill = "20"; mana = "8"; mantra = "Zayin Kun"; map = "Vaelen"; dungeon = "Dungeon Doom"; world = "Land of Vaelen"; syth = "Lady Kath of Naelex"; scroll = "SythDatacron02"; 
			...
			else if ( spellID == 272 ){ name = "Projection"; icon="21287"; crystal = "24"; skill = "30"; mana = "12"; mantra = "Rhak Skuri"; map = "Vaelen"; dungeon = "the Ancient Pyramid"; world = "Land of Vaelen"; syth = "Saint Kargoth"; scroll = "SythDatacron03"; 
			...
			else if ( spellID == 273 ){ name = "Throw Sword"; icon="1005"; crystal = "12"; skill = "40"; mana = "16"; mantra = "Chwit Sutta"; map = "Vaelen"; dungeon = "Dungeon Exodus"; world = "Land of Vaelen"; syth = "Sir Maeril of Naelax"; scroll = "SythDatacron04"; 
			...
			else if ( spellID == 274 ){ name = "Speed"; icon="1043"; crystal = "80"; skill = "50"; mana = "20"; mantra = "Qyasik Tukata"; map = "Vaelen"; dungeon = "Dungeon Clues"; world = "Land of Vaelen"; syth = "Lord Monduiz Dephaar"; scroll = "SythDatacron05"; 
			...
			else if ( spellID == 275 ){ name = "Syth Lightning"; icon="1010"; crystal = "32"; skill = "60"; mana = "24"; mantra = "Sutta Wo"; map = "Vaelen"; dungeon = "the Mausoleum"; world = "Island of Umber Veil"; syth = "Lord Androma of Gara"; scroll = "SythDatacron06"; 
			...
			else if ( spellID == 276 ){ name = "Absorption"; icon="23015"; crystal = "500"; skill = "70"; mana = "28"; mantra = "Taral Wai"; map = "Vaelen"; dungeon = "the City of the Dead"; world = "Land of Ambrosia"; syth = "Sir Farian of Lirtham"; scroll = "SythDatacron07"; 
		...
		public static int ComputePowerValue( Mobile from, int div )
		{
			...
			int v = (int) Math.Sqrt( ( from.Karma * -1 ) + 20000 + ( from.Skills.Psychology.Fixed * 10 ) );
