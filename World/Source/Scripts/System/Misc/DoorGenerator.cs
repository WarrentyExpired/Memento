...
namespace Server
{
	public class DoorGenerator
	{
		...
		private static Rectangle2D[] m_SerpentIslandRegions = new Rectangle2D[]
			{
		...
		public static void Generate()
		{
			...
			m_Map = Map.SerpentIsland;
			m_Count = 0;

			for ( int i = 0; i < m_SerpentIslandRegions.Length; ++i )
				Generate( m_SerpentIslandRegions[i] );
